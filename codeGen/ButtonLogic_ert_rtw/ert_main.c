...
#include "ButtonLogic.h"               /* Model header file */
...
void rt_OneStep(void)
{
    ...
    /* Check for overrun */
    if (OverrunFlag) {
        rtmSetErrorStatus(ButtonLogic_M, "Overrun");
        return;
    }
...
int main(int argc, const char *argv[])
{
    ...
    fflush((NULL));
    while (rtmGetErrorStatus(ButtonLogic_M) == (NULL)) {
        /*  Perform application tasks here */
    }

    /* Terminate model */
    ButtonLogic_terminate();
    return 0;
}
